...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['pay_now']) && $subscription_id && !empty($_POST['razorpay_payment_id'])) {
    ...
    if ($subscription_details) {
        ...
        $delivery_time = $subscription_details['delivery_time'];
    ...
    if (!empty($user['phone'])) {
        ...
        $whatsappLink = getOrderConfirmationLink($user_id, $subscriptionDetails);
            ...
            <div class="payment-container">
                ...
                <?php elseif ($subscription_id && ($payment_status === 'paid' || isset($_GET['paid']))): ?>
                    <div class="success-message">
                        ...
                        <?php if (isset($_SESSION['whatsapp_notification_link'])): ?>
                            <div style="margin: 25px 0; padding: 15px; background: #e8f5e9; border-radius: 8px; text-align: center;">
                                ...
                                <a href="<?php echo htmlspecialchars($_SESSION['whatsapp_notification_link']); ?>" 
                                   target="_blank" 
                            ...
                            <?php unset($_SESSION['whatsapp_notification_link']); ?>
                        <?php endif; ?>
